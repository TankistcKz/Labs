...
flat_rec = flatten_recursive(base_list)
flat_iter = flatten_iterative(base_list)

print("Рекурсивный flatten:", flat_rec[:20], "...")
print("Итеративный flatten:", flat_iter[:20], "...")
print("Длина списка:", len(flat_rec))
